...
const EmailPreviewPane = ({ formData, isPaid, isCheckIn = false, eventInfo }) => {
  ...
  const preview = useMemo(
    () =>
      buildEmailPreview({
        template: {
          ...
          customImage: { url: formData.emailTemplateCustomImageUrl, width: formData.emailTemplateCustomImageWidth },
    ...
    [
      ...
      formData.emailTemplateCustomImageWidth,
      formData.emailTemplateCustomLink,
