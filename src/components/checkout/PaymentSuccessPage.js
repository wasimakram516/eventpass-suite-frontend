...
// Checkout owns all payment result screens.
...
export default function PaymentSuccessPage({
  ...
  useEffect(() => {
    ...
    const verifyCheckout = async () => {
      const result = await verify(registrationId);
          ...
          >
            ...
            >
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5, width: "100%" }}>
                ...
                <Button
                  variant="outlined"
                  href={`${eventRouteBase}/${lang}/event/${eventSlug}`}
                  fullWidth
                  size="large"
            ...
            >
              ...
              <Box ref={badgeRef} sx={{ width: "100%", maxWidth: 430 }}>
                <BadgeCard
                  ...
                  module={eventData?.module || moduleName}
                  qrRef={qrRef}
                  t={t}
                  compact={false}
                />
