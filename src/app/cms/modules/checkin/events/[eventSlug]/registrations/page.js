        ...
        return allRegistrations.filter((reg) => {
            ...
            for (const [key, rawValue] of Object.entries(restFilters)) {
                ...
                if (key === "token") {
                    const tokenMatch =
                        !rawValue ||
                        (reg.token || "").toLowerCase().includes(String(rawValue).toLowerCase());
                                ...
                                >
                                    ...
                                    >
                                        <Stack spacing={0.6}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Tooltip title={t.copyToken}>
                                                        <IconButton
                                                            size="small"
                                                            onClick={() => navigator.clipboard.writeText(reg.token)}
                                                            sx={{
                                                                p: 0.5,
                                                                color: "primary.main",
                                            ...
                                            <Stack direction="row" alignItems="center" spacing={0.6} sx={{ mt: 0.3 }}>
                                        ...
                                        >
                                            <FormControl size="small" sx={{ minWidth: 140 }}>
                                                <Select
                                                    ...
                                                    onChange={(e) => handleApprovalChange(reg._id, e.target.value)}
                                                    sx={{ fontSize: "0.9rem" }}
                                                >
