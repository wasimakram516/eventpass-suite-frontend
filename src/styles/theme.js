...
const theme = createTheme({
  ...
  typography: {
    ...
    h6: { fontFamily: "'Aktiv Grotesk', sans-serif", fontSize: "1.25rem" },
    body1: { fontSize: "1.075rem", fontFamily: "'Aktiv Grotesk', sans-serif" },
    body2: { fontSize: "0.95rem", fontFamily: "'Aktiv Grotesk', sans-serif" },
