...
const useStageQSocket = ({ sessionSlug, onVoteUpdated, onAnsweredUpdated, onNewQuestion, onNewQuestionAdmin, onTextUpdated, onQuestionDeleted }) => {
  ...
  const cbRef = useRef({});
  cbRef.current = { onVoteUpdated, onAnsweredUpdated, onNewQuestion, onNewQuestionAdmin, onTextUpdated, onQuestionDeleted };
  ...
  const events = useMemo(() => ({
    ...
    newQuestionAdmin: (data) => cbRef.current.onNewQuestionAdmin?.(data),
